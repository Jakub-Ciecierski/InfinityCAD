...
ContextMenu* ObjectsCMenuFactory::create(){
    ...
    objectListContextMenu->addActionAndHandler((OBJECTS_MENU_ADD_NAME),
                                    OBJECTS_MENU_ADD_HANDLER);
    objectListContextMenu->addActionAndHandler((OBJECTS_MENU_ADD_NAMED_NAME),
                                    OBJECTS_MENU_ADD_NAMED_HANDLER);
    objectListContextMenu->addActionAndHandler((OBJECTS_MENU_PROPERTIES_NAME),
                                    Handler(func));
