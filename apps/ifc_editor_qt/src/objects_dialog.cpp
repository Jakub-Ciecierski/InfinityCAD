...
void ObjectsDialog::surfaceC2RectButtonClick(){
    addObject(RB_SURFACE_C2_RECT_TYPE);
}

void ObjectsDialog::surfaceC2CylindButtonClick(){
    addObject(RB_SURFACE_C2_CYLIND_TYPE);
}
